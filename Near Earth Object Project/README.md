## Overview
This program searches for and explores close approaches of near-Earth objects (NEOs), using data from NASA/JPL's Center for Near-Earth Object Studies.
...
The purpose of each of these files and folders:
